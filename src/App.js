...
import { setUser, addCustomMask, pruneBadClouds } from "./redux/actions"; //TO-DO: is setUser needed?
      ...
      >
        <Switch>
          ...
          <Route
            ...
            exact
            render={(routerProps) => (
              <SongDetail history={routerProps.history} />
            )}
          />
          ...
          <Route
            render={() => <Redirect to={user ? paths.search : paths.about} />}
          />
        </Switch>
      </Paper>
      <Footer />
...
export default connect(mapState, { setUser, addCustomMask, pruneBadClouds })(
  App
);
