    ...
    <Grid className={classes.artistPage}>
      ...
      <Grid className={classes.mainContent} container>
        ...
        <Grid item xs={12} sm={6} classes={{ root: classes.mainContentChild }}>
          <Paper
            elevation={0}
            className={classNames(classes.wordCloudPaper, classes.sectionPaper)}
          >
            <IconButton
              className={classes.sectionToggleBtn}
        ...
        <Grid item xs={12} sm={6} classes={{ root: classes.mainContentChild }}>
          <Paper
            elevation={0}
            className={classNames(classes.songsPaper, classes.sectionPaper)}
          >
            <IconButton
              className={classes.sectionToggleBtn}
              onClick={toggleSongsExpanded}
            >
